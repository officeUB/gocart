...
<form class="" action="{{route('seller.products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
    <div class="row gutters-5">
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Product Technical Specification')}}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" lang="en" min="0" value="0" step="0.01"
                                placeholder="{{ translate('Enter Length') }}" name="length" class="form-control" required>
                        </div>
                        <div class="col-md-3">
                            <select class="form-control aiz-selectpicker" name="length_type">
                                <option value="cm">{{translate('CM')}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" lang="en" min="0" value="0" step="0.01"
                                placeholder="{{ translate('Enter Width') }}" name="width" class="form-control" required>
                        </div>
                        <div class="col-md-3">
                            <select class="form-control aiz-selectpicker" name="width">
                                <option value="cm">{{translate('CM')}}</option>
                                <option value="m">{{translate('Meter')}}</option>
                                <option value="kg">{{translate('Kilogram')}}</option>
                                <option value="inch">{{translate('Inch')}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" lang="en" min="0" value="0" step="0.01"
                                placeholder="{{ translate('Enter Height') }}" name="height" class="form-control" required>
                        </div>
                        <div class="col-md-3">
                            <select class="form-control aiz-selectpicker" name="height_type">
                                <option value="cm">{{translate('CM')}}</option>
                                <option value="m">{{translate('Meter')}}</option>
                                <option value="kg">{{translate('Kilogram')}}</option>
                                <option value="inch">{{translate('Inch')}}</option>
